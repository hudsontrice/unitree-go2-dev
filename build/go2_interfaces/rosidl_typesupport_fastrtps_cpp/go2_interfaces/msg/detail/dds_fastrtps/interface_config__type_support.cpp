...
#include "go2_interfaces/msg/detail/interface_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_interfaces::msg::InterfaceConfig & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::InterfaceConfig & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::InterfaceConfig;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::InterfaceConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::InterfaceConfig *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::InterfaceConfig>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_InterfaceConfig__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, InterfaceConfig)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_InterfaceConfig__handle;
}
