...
#include "go2_interfaces/msg/detail/audio_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_interfaces::msg::AudioData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::AudioData & ros_message)
{
  // Member: time_frame
  cdr >> ros_message.time_frame;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::AudioData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::AudioData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::AudioData *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::AudioData>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_AudioData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, AudioData)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_AudioData__handle;
}
