...
#include "go2_interfaces/msg/detail/low_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const go2_interfaces::msg::MotorState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  go2_interfaces::msg::MotorState &);
size_t get_serialized_size(
  const go2_interfaces::msg::MotorState &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const go2_interfaces::msg::BmsState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  go2_interfaces::msg::BmsState &);
size_t get_serialized_size(
  const go2_interfaces::msg::BmsState &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const go2_interfaces::msg::LowState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: imu_state
  go2_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::LowState & ros_message)
{
  // Member: head
  {
    cdr >> ros_message.head;
  ...
  // Member: imu_state
  go2_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    go2_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: imu_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        go2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_IMU(
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        go2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: bms_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        go2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_BmsState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::LowState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::LowState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::LowState *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::LowState>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_LowState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, LowState)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_LowState__handle;
}
