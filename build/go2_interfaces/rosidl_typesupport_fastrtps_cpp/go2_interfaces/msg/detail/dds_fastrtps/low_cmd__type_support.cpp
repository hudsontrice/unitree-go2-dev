...
#include "go2_interfaces/msg/detail/low_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const go2_interfaces::msg::MotorCmd &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  go2_interfaces::msg::MotorCmd &);
...
cdr_serialize(
  const go2_interfaces::msg::LowCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::LowCmd & ros_message)
{
  // Member: head
  {
    cdr >> ros_message.head;
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        go2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCmd(
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::LowCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::LowCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::LowCmd *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::LowCmd>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, LowCmd)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
