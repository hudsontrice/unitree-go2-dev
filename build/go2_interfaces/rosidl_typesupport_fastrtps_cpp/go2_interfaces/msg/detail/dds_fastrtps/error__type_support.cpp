...
#include "go2_interfaces/msg/detail/error__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_interfaces::msg::Error & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::Error & ros_message)
{
  // Member: source
  cdr >> ros_message.source;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::Error;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::Error *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::Error *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::Error>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_Error__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, Error)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_Error__handle;
}
