...
#include "go2_interfaces/msg/detail/uwb_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_interfaces::msg::UwbState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::UwbState & ros_message)
{
  // Member: version
  {
    cdr >> ros_message.version;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::UwbState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::UwbState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::UwbState *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::UwbState>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_UwbState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, UwbState)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_UwbState__handle;
}
