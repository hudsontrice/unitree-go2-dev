...
#include "go2_interfaces/msg/detail/sport_mode_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const go2_interfaces::msg::BmsCmd &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  go2_interfaces::msg::BmsCmd &);
...
{
bool cdr_serialize(
  const go2_interfaces::msg::PathPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  go2_interfaces::msg::PathPoint &);
size_t get_serialized_size(
  const go2_interfaces::msg::PathPoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const go2_interfaces::msg::SportModeCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::SportModeCmd & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  // Member: bms_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        go2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_BmsCmd(
  ...
  // Member: path_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        go2_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_PathPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::SportModeCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::SportModeCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::SportModeCmd *>(
    untyped_ros_message);
...
get_message_type_support_handle<go2_interfaces::msg::SportModeCmd>()
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_SportModeCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, SportModeCmd)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_SportModeCmd__handle;
}
