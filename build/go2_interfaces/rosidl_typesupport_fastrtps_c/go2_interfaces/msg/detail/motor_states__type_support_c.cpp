...
#include "go2_interfaces/msg/detail/motor_states__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/motor_state__functions.h"  // states

// forward declare type support functions
size_t get_serialized_size_go2_interfaces__msg__MotorState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_interfaces__msg__MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, MotorState)();


using _MotorStates__ros_msg_type = go2_interfaces__msg__MotorStates;
  ...
  // Field name: states
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, MotorState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: states
  {
    ...
    if (ros_message->states.data) {
      go2_interfaces__msg__MotorState__Sequence__fini(&ros_message->states);
    }
    if (!go2_interfaces__msg__MotorState__Sequence__init(&ros_message->states, size)) {
...
size_t get_serialized_size_go2_interfaces__msg__MotorStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorStates__ros_msg_type * ros_message = static_cast<const _MotorStates__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_go2_interfaces__msg__MotorState(
...
static uint32_t _MotorStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__MotorStates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__MotorStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__MotorState(
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__MotorStates;
    is_plain =
      (
...
static size_t _MotorStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__MotorStates(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, MotorStates)() {
