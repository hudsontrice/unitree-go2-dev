...
#include "go2_interfaces/msg/detail/motor_cmds__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/motor_cmd__functions.h"  // cmds

// forward declare type support functions
size_t get_serialized_size_go2_interfaces__msg__MotorCmd(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_interfaces__msg__MotorCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, MotorCmd)();


using _MotorCmds__ros_msg_type = go2_interfaces__msg__MotorCmds;
  ...
  // Field name: cmds
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, MotorCmd
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cmds
  {
    ...
    if (ros_message->cmds.data) {
      go2_interfaces__msg__MotorCmd__Sequence__fini(&ros_message->cmds);
    }
    if (!go2_interfaces__msg__MotorCmd__Sequence__init(&ros_message->cmds, size)) {
...
size_t get_serialized_size_go2_interfaces__msg__MotorCmds(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorCmds__ros_msg_type * ros_message = static_cast<const _MotorCmds__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name cmds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_go2_interfaces__msg__MotorCmd(
...
static uint32_t _MotorCmds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__MotorCmds(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__MotorCmds(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: cmds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__MotorCmd(
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__MotorCmds;
    is_plain =
      (
...
static size_t _MotorCmds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__MotorCmds(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, MotorCmds)() {
