...
#include "go2_interfaces/msg/detail/audio_data__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/audio_data__struct.h"
...
using _AudioData__ros_msg_type = go2_interfaces__msg__AudioData;
...
size_t get_serialized_size_go2_interfaces__msg__AudioData(
  const void * untyped_ros_message,
...
static uint32_t _AudioData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__AudioData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__AudioData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__AudioData;
    is_plain =
      (
...
static size_t _AudioData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__AudioData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, AudioData)() {
