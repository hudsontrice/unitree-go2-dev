...
#ifndef GO2_INTERFACES__MSG__DETAIL__LOW_CMD__STRUCT_HPP_
#define GO2_INTERFACES__MSG__DETAIL__LOW_CMD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__go2_interfaces__msg__LowCmd __attribute__((deprecated))
#else
# define DEPRECATED__go2_interfaces__msg__LowCmd __declspec(deprecated)
#endif
...
struct LowCmd_
{
  ...
  : bms_cmd(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->bandwidth = 0;
      this->motor_cmd.fill(go2_interfaces::msg::MotorCmd_<ContainerAllocator>{_init});
    ...
    fan(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint32_t, 2>::iterator, uint32_t>(this->version.begin(), this->version.end(), 0ul);
      this->bandwidth = 0;
      this->motor_cmd.fill(go2_interfaces::msg::MotorCmd_<ContainerAllocator>{_alloc, _init});
      std::fill<typename std::array<uint8_t, 40>::iterator, uint8_t>(this->wireless_remote.begin(), this->wireless_remote.end(), 0);
      std::fill<typename std::array<uint8_t, 12>::iterator, uint8_t>(this->led.begin(), this->led.end(), 0);
      std::fill<typename std::array<uint8_t, 2>::iterator, uint8_t>(this->fan.begin(), this->fan.end(), 0);
      this->gpio = 0;
  ...
  using _motor_cmd_type =
    std::array<go2_interfaces::msg::MotorCmd_<ContainerAllocator>, 20>;
  ...
  Type & set__motor_cmd(
    const std::array<go2_interfaces::msg::MotorCmd_<ContainerAllocator>, 20> & _arg)
  {
    this->motor_cmd = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    go2_interfaces::msg::LowCmd_<ContainerAllocator> *;
  using ConstRawPtr =
    const go2_interfaces::msg::LowCmd_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      go2_interfaces::msg::LowCmd_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__go2_interfaces__msg__LowCmd
    std::shared_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__go2_interfaces__msg__LowCmd
    std::shared_ptr<go2_interfaces::msg::LowCmd_<ContainerAllocator> const>
...
using LowCmd =
  go2_interfaces::msg::LowCmd_<std::allocator<void>>;
...
#endif  // GO2_INTERFACES__MSG__DETAIL__LOW_CMD__STRUCT_HPP_
