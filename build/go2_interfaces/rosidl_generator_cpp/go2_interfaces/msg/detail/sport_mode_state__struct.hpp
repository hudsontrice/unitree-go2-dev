...
#ifndef GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_STATE__STRUCT_HPP_
#define GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__go2_interfaces__msg__SportModeState __attribute__((deprecated))
#else
# define DEPRECATED__go2_interfaces__msg__SportModeState __declspec(deprecated)
#endif
...
struct SportModeState_
{
  ...
  using _stamp_type =
    go2_interfaces::msg::TimeSpec_<ContainerAllocator>;
  _stamp_type stamp;
  ...
  Type & set__stamp(
    const go2_interfaces::msg::TimeSpec_<ContainerAllocator> & _arg)
  {
    this->stamp = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    go2_interfaces::msg::SportModeState_<ContainerAllocator> *;
  using ConstRawPtr =
    const go2_interfaces::msg::SportModeState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      go2_interfaces::msg::SportModeState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__go2_interfaces__msg__SportModeState
    std::shared_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__go2_interfaces__msg__SportModeState
    std::shared_ptr<go2_interfaces::msg::SportModeState_<ContainerAllocator> const>
...
using SportModeState =
  go2_interfaces::msg::SportModeState_<std::allocator<void>>;
...
#endif  // GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_STATE__STRUCT_HPP_
