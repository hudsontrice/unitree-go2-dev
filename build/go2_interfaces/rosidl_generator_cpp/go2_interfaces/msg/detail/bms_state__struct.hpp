...
#ifndef GO2_INTERFACES__MSG__DETAIL__BMS_STATE__STRUCT_HPP_
#define GO2_INTERFACES__MSG__DETAIL__BMS_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__go2_interfaces__msg__BmsState __attribute__((deprecated))
#else
# define DEPRECATED__go2_interfaces__msg__BmsState __declspec(deprecated)
#endif
...
struct BmsState_
{
  ...
  using ConstRawPtr =
    const go2_interfaces::msg::BmsState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      go2_interfaces::msg::BmsState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__go2_interfaces__msg__BmsState
    std::shared_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__go2_interfaces__msg__BmsState
    std::shared_ptr<go2_interfaces::msg::BmsState_<ContainerAllocator> const>
...
using BmsState =
  go2_interfaces::msg::BmsState_<std::allocator<void>>;
...
#endif  // GO2_INTERFACES__MSG__DETAIL__BMS_STATE__STRUCT_HPP_
