...
#ifndef GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_CMD__STRUCT_HPP_
#define GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_CMD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__go2_interfaces__msg__SportModeCmd __attribute__((deprecated))
#else
# define DEPRECATED__go2_interfaces__msg__SportModeCmd __declspec(deprecated)
#endif
...
struct SportModeCmd_
{
  ...
  : bms_cmd(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->yaw_speed = 0.0f;
      this->path_point.fill(go2_interfaces::msg::PathPoint_<ContainerAllocator>{_init});
    }
  }
    ...
    path_point(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<float, 2>::iterator, float>(this->velocity.begin(), this->velocity.end(), 0.0f);
      this->yaw_speed = 0.0f;
      this->path_point.fill(go2_interfaces::msg::PathPoint_<ContainerAllocator>{_alloc, _init});
    }
  }
  ...
  using _bms_cmd_type =
    go2_interfaces::msg::BmsCmd_<ContainerAllocator>;
  _bms_cmd_type bms_cmd;
  using _path_point_type =
    std::array<go2_interfaces::msg::PathPoint_<ContainerAllocator>, 30>;
  ...
  Type & set__bms_cmd(
    const go2_interfaces::msg::BmsCmd_<ContainerAllocator> & _arg)
  {
    this->bms_cmd = _arg;
    return *this;
  }
  Type & set__path_point(
    const std::array<go2_interfaces::msg::PathPoint_<ContainerAllocator>, 30> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    go2_interfaces::msg::SportModeCmd_<ContainerAllocator> *;
  using ConstRawPtr =
    const go2_interfaces::msg::SportModeCmd_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      go2_interfaces::msg::SportModeCmd_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__go2_interfaces__msg__SportModeCmd
    std::shared_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__go2_interfaces__msg__SportModeCmd
    std::shared_ptr<go2_interfaces::msg::SportModeCmd_<ContainerAllocator> const>
...
using SportModeCmd =
  go2_interfaces::msg::SportModeCmd_<std::allocator<void>>;
...
#endif  // GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_CMD__STRUCT_HPP_
