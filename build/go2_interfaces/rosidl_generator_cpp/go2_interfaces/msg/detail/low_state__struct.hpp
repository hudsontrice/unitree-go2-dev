...
#ifndef GO2_INTERFACES__MSG__DETAIL__LOW_STATE__STRUCT_HPP_
#define GO2_INTERFACES__MSG__DETAIL__LOW_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__go2_interfaces__msg__LowState __attribute__((deprecated))
#else
# define DEPRECATED__go2_interfaces__msg__LowState __declspec(deprecated)
#endif
...
struct LowState_
{
    ...
    bms_state(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->bandwidth = 0;
      this->motor_state.fill(go2_interfaces::msg::MotorState_<ContainerAllocator>{_init});
    ...
    fan_frequency(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint32_t, 2>::iterator, uint32_t>(this->version.begin(), this->version.end(), 0ul);
      this->bandwidth = 0;
      this->motor_state.fill(go2_interfaces::msg::MotorState_<ContainerAllocator>{_alloc, _init});
      std::fill<typename std::array<int16_t, 4>::iterator, int16_t>(this->foot_force.begin(), this->foot_force.end(), 0);
      std::fill<typename std::array<int16_t, 4>::iterator, int16_t>(this->foot_force_est.begin(), this->foot_force_est.end(), 0);
      this->tick = 0ul;
      std::fill<typename std::array<uint8_t, 40>::iterator, uint8_t>(this->wireless_remote.begin(), this->wireless_remote.end(), 0);
  ...
  using _motor_state_type =
    std::array<go2_interfaces::msg::MotorState_<ContainerAllocator>, 20>;
  _motor_state_type motor_state;
  using _bms_state_type =
    go2_interfaces::msg::BmsState_<ContainerAllocator>;
  ...
  Type & set__imu_state(
    const go2_interfaces::msg::IMU_<ContainerAllocator> & _arg)
  {
    this->imu_state = _arg;
    return *this;
  }
  Type & set__motor_state(
    const std::array<go2_interfaces::msg::MotorState_<ContainerAllocator>, 20> & _arg)
  {
    this->motor_state = _arg;
    return *this;
  }
  Type & set__bms_state(
    const go2_interfaces::msg::BmsState_<ContainerAllocator> & _arg)
  {
    this->bms_state = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    go2_interfaces::msg::LowState_<ContainerAllocator> *;
  using ConstRawPtr =
    const go2_interfaces::msg::LowState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<go2_interfaces::msg::LowState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<go2_interfaces::msg::LowState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      go2_interfaces::msg::LowState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::LowState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::LowState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<go2_interfaces::msg::LowState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<go2_interfaces::msg::LowState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__go2_interfaces__msg__LowState
    std::shared_ptr<go2_interfaces::msg::LowState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__go2_interfaces__msg__LowState
    std::shared_ptr<go2_interfaces::msg::LowState_<ContainerAllocator> const>
...
using LowState =
  go2_interfaces::msg::LowState_<std::allocator<void>>;
...
#endif  // GO2_INTERFACES__MSG__DETAIL__LOW_STATE__STRUCT_HPP_
