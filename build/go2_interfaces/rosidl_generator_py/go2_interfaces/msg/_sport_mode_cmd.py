    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'go2_interfaces.msg.SportModeCmd')
            logger.debug(
...
class SportModeCmd(metaclass=Metaclass_SportModeCmd):
    ...
    _fields_and_field_types = {
        ...
        'velocity': 'float[2]',
        'yaw_speed': 'float',
        'bms_cmd': 'go2_interfaces/BmsCmd',
        'path_point': 'go2_interfaces/PathPoint[30]',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('float'), 2),  # noqa: E501
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'BmsCmd'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'PathPoint'), 30),  # noqa: E501
    )
