...
class Metaclass_LowState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from go2_interfaces.msg import BmsState
            ...
            from go2_interfaces.msg import MotorState
...
class LowState(metaclass=Metaclass_LowState):
    ...
    _fields_and_field_types = {
        ...
        'version': 'uint32[2]',
        'bandwidth': 'uint16',
        'imu_state': 'go2_interfaces/IMU',
        'motor_state': 'go2_interfaces/MotorState[20]',
        'bms_state': 'go2_interfaces/BmsState',
        'foot_force': 'int16[4]',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'IMU'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'MotorState'), 20),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'BmsState'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from go2_interfaces.msg import IMU
        self.imu_state = kwargs.get('imu_state', IMU())
        from go2_interfaces.msg import MotorState
    ...
    def imu_state(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'imu_state' field must be a sub message of type 'IMU'"
