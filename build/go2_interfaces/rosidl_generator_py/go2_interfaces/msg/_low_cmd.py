...
class Metaclass_LowCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from go2_interfaces.msg import MotorCmd
...
class LowCmd(metaclass=Metaclass_LowCmd):
    ...
    _fields_and_field_types = {
        ...
        'version': 'uint32[2]',
        'bandwidth': 'uint16',
        'motor_cmd': 'go2_interfaces/MotorCmd[20]',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'MotorCmd'), 20),  # noqa: E501
