    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'go2_interfaces.msg.SportModeState')
            logger.debug(
            ...
            from go2_interfaces.msg import TimeSpec
...
class SportModeState(metaclass=Metaclass_SportModeState):
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'TimeSpec'),  # noqa: E501
